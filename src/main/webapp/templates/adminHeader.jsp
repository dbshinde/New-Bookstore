...
<div id="templatemo_container">
    <div id="templatemo_menu">
        <ul>
            <li><a href="adminDashboard.jsp" class="current">Home</a></li>
            <li><%
                User loggedInUser = (User) session.getAttribute(LoginPage.LOGGED_IN_USER);
                if (loggedInUser != null) {
            	%>
            		<a href="adminSearch.jsp" class="current">Search</a>
            		<a href="addBook.jsp" class="current">Add new Book</a>
	            <%
	            } 
	            %>
            </li>
        ...
        <div>
            ...
            <form method="post" name="loginForm" style="float: right;" action="index.jsp">
				...
				<input type="hidden" value="true" name="<%=LoginPage.PARAM_IS_ADMIN%>" />
